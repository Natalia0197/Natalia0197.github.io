...
subtemas:
  ...
  - numero: "3.2.2.1"
    titulo: "Llamados a Funciones Relacionadas con Semáforo"
    url: "/temas/03-ipc/funciones-semaforo"
    descripcion: "Funciones semget(), semop() y semctl() para manejo de semáforos en System V."
  - numero: "3.2.3"
    titulo: "Semáforos en POSIX"
    url: "/temas/03-ipc/semaforos-posix"
    descripcion: "Uso de semáforos POSIX como alternativa moderna a los semáforos System V."
  - numero: "3.2.3.1"
    titulo: "Sincronización de Hilos con Mutex"
    url: "/temas/03-ipc/mutex"
    descripcion: "Uso de mutex para sincronizar el acceso a recursos compartidos entre hilos."
  - numero: "3.3"
